# Java Projektek Gyűjteménye

Ez a repozitórium különféle Java-projekteket tartalmaz, amelyek között megtalálhatók az algoritmusok, grafikus felhasználói felület (GUI) alkalmazások, valamint egyetemi feladatok megoldásai. Az alábbiakban részletes információkat találhatsz a repozitóriumban szereplő algoritmusokról és azok működéséről.

## Tartalom
- [Buborék rendezés (Bubble Sort)](#buborek-rendezes-bubble-sort)
- [Kiválasztásos rendezés (Selection Sort)](#kivalasztasos-rendezes-selection-sort)
- [Beszúró rendezés (Insertion Sort)](#beszuro-rendezes-insertion-sort)
- [Gyorsrendezés (Quick Sort)](#gyorsrendezes-quick-sort)
- [Halmazrendezés (Merge Sort)](#halmazrendezes-merge-sort)
